...
[![Trials](https://img.shields.io/badge/trials-126%20passed%20in%20the%20fires-ffb03a?labelColor=0a0705)](#-the-trials)
...
2. **Auth** — subscription or key, the orchestrator model (Opus 5 rules them all by default), and the daily spend cap
...
# 126 runs, 675 assertions, 0 failures — passed in the fires of Mount Doom (a stub CLI;
